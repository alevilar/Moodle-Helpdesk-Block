...
echo $OUTPUT->header();
	...
	if ( count($answers) ) {
		...
		echo "<ul class='changes' style='margin-left: 0px'>";
		foreach ($answers as $a) {
			...
			$responsss = ($a->changetypeid == CHANGE_TYPE_COMMENT)? get_string('responds', 'block_helpdesk').':<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':': ';
		    	...
		    	echo "<li class='changetype-id-$a->changetypeid'><span class='date'>$date</span><span class='username'> $url_profile $responsss<span class='answers'>$a->text<span></li>";
		}
		echo "</ul>";
	}
